  ...
  group('gpt2:', () {
    ...
    test('too many requests', () async {
      ...
      try {
        ...
        fail('Expected HuggingFaceTooManyRequestsError');
      } on HuggingFaceTooManyRequestsError catch (e) {
    ...
    test('model not found', () async {
      ...
      try {
        await api.run<String>(input);
        fail('Expected HuggingFaceModelNotFoundError');
      } on HuggingFaceModelNotFoundError catch (e) {
    ...
    test('model loading', () async {
      ...
      try {
        await api.run<String>(input);
        fail('Expected HuggingFaceLoadingError');
      } on HuggingFaceLoadingError catch (e) {
        expect(e.message,
    ...
    test('unknown error', () async {
      ...
      try {
        await api.run<String>(input);
        fail('Expected HuggingFaceUnknownError');
      } on HuggingFaceUnknownError catch (e) {
